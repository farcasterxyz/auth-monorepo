...
export function pollStatusTillSuccessQueryOptions(config: Config, options: PollStatusTillSuccessOptions = {} as any) {
  return {
    // TODO: Support `signal`
    ...
    async queryFn({ queryKey }) {
      ...
      return pollStatusTillSuccess(config, { channelToken, timeout, interval }) as Promise<PollStatusTillSuccessData>;
    },
...
export function pollStatusTillSuccessQueryKey(options: PollStatusTillSuccessOptions = {} as any) {
