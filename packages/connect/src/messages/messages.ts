...
import { ConnectResult, ConnectAsyncResult, ConnectError } from "../errors";
 ...
 * userData fields.
 */
export const build = (params: ConnectParams): ConnectResult<SiweMessage> => {
...
): ConnectAsyncResult<ConnectResponse> => {
 ...
 */
export const parseResources = (message: SiweMessage): ConnectResult<ConnectResourceParams> => {
 ...
 */
export const parseUserData = (message: SiweMessage): ConnectResult<ConnectResourceParams | undefined> => {
  const resource = (message.resources ?? []).find((resource) => {
...
const mergeResources = (response: SiweResponse): ConnectResult<ConnectResponse> => {
